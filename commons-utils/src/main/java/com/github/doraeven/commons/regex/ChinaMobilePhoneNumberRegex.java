...
public class ChinaMobilePhoneNumberRegex {
	...
	public static final String ALL_NUMBER_REGEX = "^(?:\\+?86)?1(?:3\\d{3}|5[^4\\D]\\d{2}|8\\d{3}|7(?:[0-35-9]\\d{2}|4(?:0\\d|1[0-2]|9\\d))|9[0-35-9]\\d{2}|6[2567]\\d{2}|4(?:(?:10|4[01])\\d{3}|[68]\\d{4}|[579]\\d{2}))\\d{6}$";

	// Match all numbers with SMS (Phone number + Data only number)
	public static final String ALL_NUMBER_WITH_SMS_REGEX = "^(?:\\+?86)?1(?:3\\d{3}|5[^4\\D]\\d{2}|8\\d{3}|7(?:[0-35-9]\\d{2}|4(?:0\\d|1[0-2]|9\\d))|9[0-35-9]\\d{2}|6[2567]\\d{2}|4[579]\\d{2})\\d{6}$";

	// ## Mobile phone number

	// Match all
	public static final String ALL_PHONE_NUMBER_REGEX = "^(?:\\+?86)?1(?:3\\d{3}|5[^4\\D]\\d{2}|8\\d{3}|7(?:[235-8]\\d{2}|4(?:0\\d|1[0-2]|9\\d))|9[0-35-9]\\d{2}|66\\d{2})\\d{6}$";
	...
	// Match all
	public static final String ALL_MVNO_NUMBER_REGEX = "^(?:\\+?86)?1(?:7[01]|6[257])\\d{8}$";
	...
	// Match all
	public static final String ALL_IOT_NUMBER_REGEX = "^(?:\\+?86)?14(?:[14]0|41|[68]\\d)\\d{9}$";
	...
	// Match all
	public static final String ALL_DATA_NUMBER_REGEX = "^(?:\\+?86)?14[579]\\d{8}$";
